...
//    cycleScrollView.placeholderImage = placeholderImage;
    cycleScrollView.placeholderImage = [UIImage imageNamed:@"banner"];
    UICollectionView * colletionView = (UICollectionView *)cycleScrollView.subviews[0];
    colletionView.frame = CGRectMake(-10, 0, colletionView.frame.size.width, colletionView.frame.size.height);
//    cycleScrollView.frame = CGRectMake(0, 0, WIDTH, cycleScrollView.frame.size.height);
    return cycleScrollView;
}
...
- (void)layoutSubviews
{
    ...
    if (self.pageControlAliment == SDCycleScrollViewPageContolAlimentRight) {
        x = self.mainView.sd_width - size.width - spaceX;
    }
    CGFloat y = self.mainView.sd_height - size.height - spaceX;
